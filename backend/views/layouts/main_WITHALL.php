                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview <?=($this->context->id == 'otabuildtypes') ? 'active' : ' ' ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <!-- <li><a href="/otabuildtemplates"><i class="fa fa-file-code-o"></i> OTA Templates</a></li> -->
                            <!-- <li><a href="/useroptions"><i class="fa fa-paint-brush"></i> OTA Type</a></li> -->
                        </ul>
                    </li>
                    <?php
                    if ($userId == 1) {
                    ?>
                        <li class="treeview <?=($this->context->id == 'project') ? 'active' : ' ' ?>">
                            <a href="/project">
                                <i class="fa fa-flask"></i> <span>Projects</span>
                            </a>
                        </li>
                        <li class="treeview <?=($this->context->id == 'client') ? 'active' : ' ' ?>">
                            <a href="/client">
                                <i class="fa fa-diamond"></i> <span>Clients</span>
                            </a>
                        </li>
                        <li class=" treeview <?=($this->context->id == 'type') ? 'active' : ' ' ?>">
                            <a href="/type">
                                <i class="fa fa-desktop"></i> <span>Project type</span>
                            </a>
                        </li>
                        <li class="treeview <?=($this->context->id == 'company') ? 'active' : ' ' ?>">
                            <a href="/company">
                                <i class="fa fa-institution"></i> <span>Company</span>
                            </a>
                        </li>
                        <li class="treeview <?=($this->context->id == 'office') ? 'active' : ' ' ?>">
                            <a href="/office">
                                <i class="fa fa-building-o"></i> <span>Offices</span>
                            </a>
                        </li>
                        <li class="treeview <?=($this->context->id == 'mobgenner') ? 'active' : ' ' ?>">
                            <a href="/mobgenner">
                                <i class="fa fa-circle-o"></i> <span>Mobgenners</span>
                            </a>
                        </li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="/newfield"><i class="fa fa-indent"></i> New field</a></li>
                                <!--
                                <li><a href="/objects"><i class="fa fa-object-group"></i>Objects</a></li>
                                <li><a href="/templates"><i class="fa fa-file-text-o"></i>Templates</a></li>
                                -->
