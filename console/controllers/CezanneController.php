    ...
    public function actionCreateLocations()
    {
	    ...
	    $alocations = [
            ...
            ['location_code' => 'AMS', 'name' => 'Amsterdam', 'country' => 'The Netherlands', 'city' => 'Amsterdam',
	            ...
	            'description' => 'The Amsterdam headquarters.',
	            "last_modified_date" => $datetime,
            ],
            ['location_code' => 'COR', 'name' => 'La Coruna', 'country' => 'Spain', 'city' => 'La Coruna',
	            ...
	            'description' => 'Our second office in the North of Spain.',
	            "last_modified_date" => $datetime,
            ],
            ['location_code' => 'MAL', 'name' => 'Malaga', 'country' => 'Spain', 'city' => 'Malaga',
	            ...
	            'description' => 'Our office closest to the sun.',
	            "last_modified_date" => $datetime,
            ],
            ['location_code' => 'LON', 'name' => 'London', 'country' => 'United Kingdom', 'city' => 'London',
	            ...
	            'description' => 'And there is a London office, of course.',
	            "last_modified_date" => $datetime,
            ],
        ];
...
//		echo "curlResponse: {$curlinfo['response']}\n";
	...
	{
		echo "actionImportImage('$this->userid')\n";
