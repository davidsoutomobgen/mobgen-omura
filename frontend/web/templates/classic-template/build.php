...
<link type="text/css" rel="stylesheet" href="/templates/classic-template/css/style.css" />
...
<div id="container">
	...
	<div id="content">
		...
		<div style="margin-top:10px;">
			<div class="lbl">Version:</div> <span class="bltxt"><?=$buildata->buiVersion?><?=(!empty($buildata->buiBuildNum) ? '-'.$buildata->buiBuildNum : ''); ?></span>
		</div>
		<div id="installBox">
			<div id="install">
				<?php if ($buildata->buiType) { ?>
					<a href="/build/download/<?=$buildata->buiHash;?>">Install</a>
				<?php } else { ?>
